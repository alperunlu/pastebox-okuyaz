...
// The allowed types
$config['types'] = array('txt'=>'Text file','php' => 'PHP code','html'=>'HTML','css'=>'CSS','javascript'=>'JavaScript');
...
</ul></form><?php } ?></div><div class="clear"></div><p id="footer"><a href="http://pastebox.sf.net/">PasteBox v1.0.0</a> released under the MIT license</p></div></body></html><?php }
